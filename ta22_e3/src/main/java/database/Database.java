...
public class Database {
	...
	// -----------------------------------------------------------------
	public boolean modifyData(String db, String table, String atributos, String id, Connection conexion) {
		...
		try {
			...
			Statement st = conexion.createStatement();
			int upd = st.executeUpdate("UPDATE " + table + " SET " + atributos + " WHERE id=" + id + ";");
			...
			System.out.println("Error actualizando data: " + e);
		}
		return actualizadoCorrecto;
	}
	
	public boolean modifyDataDNI(String db, String table, String atributos, String dni, Connection conexion) {
		boolean actualizadoCorrecto = false;
		try {
			// USE database
			String queryDB = "USE " + db + ";";
			...
			Statement st = conexion.createStatement();
			int upd = st.executeUpdate("UPDATE " + table + " SET " + atributos + " WHERE dni=" + dni + ";");
	...
	// -----------------------------------------------------------------
	public java.sql.ResultSet getSingleValue(String db, String table, String id, Connection conexion) {
	...
	// -----------------------------------------------------------------
	public java.sql.ResultSet getSingleValueDNI(String db, String table, String dni, Connection conexion) {
		java.sql.ResultSet resultSet = null;
		try {
			// USE database
			String queryDB = "USE " + db + ";";
	...
	public boolean deleteDatabase(String db, String table, String id, Connection conexion) {
	...
	public boolean deleteDatabaseDNI(String db, String table, String dni, Connection conexion) {
		boolean borradoCorrecto = false;
		try {
			// USE database
			String queryDB = "USE " + db + ";";
			...
			String query = "DELETE FROM " + table + " WHERE dni='" + dni + "';";
			Statement delTable = conexion.createStatement();
