...
public class ControladorInsercionCliente implements ActionListener {

	private ModeloCliente modelo;
	private VistaInsercionCliente vista;
	...
	public ControladorInsercionCliente(ModeloCliente mod, VistaInsercionCliente vis) {
		this.modelo = mod;
		this.vista = vis;
