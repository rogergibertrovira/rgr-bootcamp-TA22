...
public class VistaBorrarVideo extends JFrame {
	...
	public VistaBorrarVideo() {
		...
		JLabel labelInfo = new JLabel("Introduce el id del video a borrar");
		...
		buttonBorrar = new JButton("Borrar video");
