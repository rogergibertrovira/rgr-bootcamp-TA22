...
public class VistaConsultaCliente extends JFrame {
	...
	public VistaConsultaCliente() {
		...
		JLabel labelInfo = new JLabel("Introduce los datos del cliente");
		...
		buttonConsultar = new JButton("Consultar cliente");
